...
CREATE DATABASE example1; -- 문장과 문장사이 ; 필수
CREATE DATABASE example2;
-- CREATE DATABASE example3 -- 다음 문장이 있는 경우 필수!

CREATE DATABASE example2; # Error Code: 1007. Can't create database 'example2'; database exists
# >> 데이터베이스 이름은 중복될 수 없음
# >> 같은 이름의 DB 두 번 생성 불가
...
COLLATE = utf8mb4_unicore_c1; # 정렬 방식 (문자열끼리 비교하고 정렬할 때 어떤 기준으로 할지 정하는 설정)
