...
insert into `integer`
value (127, 32767, 200000000, 900000000000000000);

-- insert into `integer`
-- value (128, 32767, 200000000, 900000000000000000);
...
/*
    ...
    - 논리적으로 참(True)과 거짓(False) 값을 나타냄alter
